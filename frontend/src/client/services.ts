...
export class VesselsService {
   ...
   * @throws ApiError
   */
  public static readVessel(
    data: VesselsData["ReadVessel"],
  ): CancelablePromise<VesselPublic> {
    const { vesselId } = data
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static readVessels(
    data: VesselsData["ReadVessels"] = {},
  ): CancelablePromise<VesselListPublic> {
   ...
   * @throws ApiError
   */
  public static readValves(
    data: VesselsData["ReadValves"],
  ): CancelablePromise<ValveListPublic> {
    const { vesselId, skip = 0, limit = 100 } = data
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static updateValve(
    data: VesselsData["UpdateValve"],
  ): CancelablePromise<ValvePublic> {
    const { vesselId, valveIdentifier, requestBody } = data
    return __request(OpenAPI, {
      method: "PUT",
      url: "/api/v1/vessels/{vessel_id}/valves/{valve_identifier}",
      path: {
        vessel_id: vesselId,
        valve_identifier: valveIdentifier,
      },
      body: requestBody,
      mediaType: "application/json",
      errors: {
   ...
   * @throws ApiError
   */
  public static fetchConnectedEquipment(
    data: VesselsData["FetchConnectedEquipment"],
  ): CancelablePromise<Array<string>> {
    const { vesselId, equipmentIdentifier } = data
    return __request(OpenAPI, {
      method: "GET",
