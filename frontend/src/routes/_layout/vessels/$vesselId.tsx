...
import { type VesselPublic, VesselsService } from "../../../client/index.ts"
    ...
    <>
      <Container maxW="full">
        ...
        <Box pt={12} m={4} bg="ui.dark" p={6} borderRadius="md" boxShadow="md">
          <Text fontSize="xl" color="ui.light">
            {vesselState.vessel.name}
          </Text>
          <Text>
            ID:{" "}
            <Text as="span" color="ui.dim">
              {vesselState.vessel.id}
            </Text>
          </Text>
          <Text>
            Version:{" "}
            <Text as="span" color="ui.dim">
              {vesselState.vessel.version}
            </Text>
          </Text>
          <Flex
            gap="4"
          ...
          <Text mt={6} fontStyle="italic">
            Equipment Key: VA = Valve (e.g., VA001), TA = Tank (e.g., TA001), PI
            = Pipe (e.g., PI001), PU = Pump (e.g., PU001).
          </Text>
        </Box>
      </Container>
    </>
